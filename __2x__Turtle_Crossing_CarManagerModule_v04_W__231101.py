...
class CarManager(Turtle):
    ...
    def __init__(self):
        self.all_cars = []   #because we are defining this within a Class, self. MUST be in front!
            #(for above): and NOW you can type self.all_cars.append(new_car) below - new_car gets appended.
        self.car_speed = CAR_STARTING_MOVE_DISTANCE  # TODO: once leveled up... increase by CAR_MOVE_INCREMENT
